...
| Quick/JIT/TLS | **Managed and native JIT ON with the corrected dual view by default:** rSELF=r15; nterp N-1 default ON; D-1 complete (37/37 Thread sites); W-002 CLOSED after native R2 passes 21/21 records; W-003 four-family attribution passes 8/8 under Wine and the XMM sentinel passes 6/6; JIT smoke 12/12; JIT matrix 14/14; W-004 direct Runtime singleton load native-accepted; compile records opt-in |
...
- **State:** OPEN (historical SETUP trap and native-boundary ABI defect repaired; Wine focused gates complete; native-host acceptance remains)
...
- **Evidence / analysis:** [RESULT-w003-quick-frames-analysis.md](tools/verify/win64_phase4/RESULT-w003-quick-frames-analysis.md); [RESULT-w003-frame-probe.md](tools/verify/win64_phase4/RESULT-w003-frame-probe.md); [RESULT-w003-xmm-sentinel.md](tools/verify/win64_phase4/RESULT-w003-xmm-sentinel.md)
...
- **Opened:** 2026-07-16
- **Updated:** 2026-07-26 — XMM6–XMM11 repair, matched PE/ELF gate, 8/8 frame-family attribution, and 6/6 Wine native sentinel complete; native-host closure remains
...
2. ~~**W-001**, **W-002**, **W-004**, **W-011**, **W-012**, and **W-024**~~ closed; **W-003** next needs native-host acceptance after completing the Microsoft XMM6–XMM11 repair, 8/8 attributed frame-family Wine gate, and 6/6 Wine sentinel.
