...
- **State:** OPEN (Stages 0/C/D, static invoke/JNI plus split OSR unwind, full XMM6-XMM15 boundary preservation, and dynamic-JIT metadata/registration/lifecycle are implemented locally; native acceptance remains)
...
- **Opened:** 2026-07-16
- **Updated:** 2026-07-27 — recovery/GC and chain probes pass; static and dynamic JIT fatal paths reach UEF/minidump; dynamic anchors, serialization, xdata, registration, collection/reuse lifecycle, JNI metadata, split OSR entry/return unwind, and full XMM6-XMM15 boundary preservation pass focused Wine; native XMM/OSR fatal acceptance, broader churn/sampling, and native policy/debugger/stack-budget acceptance remain
...
4. **W-010/W-014 Stage E** — repeat and accept the split OSR/invoke unwind and full XMM6-XMM15 sentinel on native Windows, add an OSR fatal path, broaden dynamic-table churn/sampling coverage, then run native policy/fault/stack acceptance.
