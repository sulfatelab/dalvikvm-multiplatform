...
- **Required native acceptance:** repeat the nterp/JIT NPE/SOE and recovery/GC evidence on Windows 10/current Windows; exact wrong-address cases; foreign VEH before/after/promotion; frame-based SEH for an unrecognized AV; debugger continue; stack-budget measurements; static fatal predecessor-UEF/dump behavior; both OSR records' lookup/live unwind plus the JIT-origin and OSR-origin fatal paths; dynamic-JIT lookup/unwind/rollback/collection/sampling stress in J-2 and J-1; full XMM6-XMM15 normal-return and unwind sentinels; and HSP-disabled startup plus forced compatibility/audit/strict rejection.
