...
| Heap memory | W-013 Stages A–E complete: explicit MoreCore-only dlmalloc, direct mspace owners, `VirtualAlloc2` ownership, `MemMap` page-state transitions, and Linux-like metadata placement; native closure stress remains OPEN |
...
- **State:** OPEN (design implemented; native closure stress remains)
...
- **Evidence:** `tools/verify/win64_w013/RESULT.md`; external dlmalloc `f3356ce`; ART Stage A `8c900a9e4b`; ART Stage B `d011d72d56`; ART Stage C `2fa301a13b`; ART Stage D `9ea15456a2`; ART Stage E `47567cebcc`; non-moving barrier cleanup `1509b1f95e`
- **Opened:** 2026-07-16
- **Updated:** 2026-07-25 — Stages A–E complete; native closure stress remains open
...
*Last snapshot: 2026-07-25 — W-001/W-011/W-012/W-024 closed; Nterp ON; corrected pagefile-section dual view is the managed/native-JIT default (12/12 smoke, 14/14 matrix); D-1 complete; direct CriticalNative and 7/7 mixed/high-FP normal/FastNative matrices pass unresolved dlsym, rebinding, method tracing, and JVMTI forced interpretation; W-013 Stages A–E are complete with Linux-like metadata placement and native closure stress remaining; Math.ceil/floor and one common ELF/PE table are restored; interpreter.cc matches upstream; compile records are opt-in; `ART_WIN64_JIT_DUAL=0` temporarily retains J-1 for diagnosis; W-025 broader real-host acceptance remains; 9 OPEN workarounds remaining.*
