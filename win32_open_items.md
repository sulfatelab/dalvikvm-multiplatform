...
- **State:** OPEN (Stages 0/C/D and static fatal boundaries implemented locally; dynamic-JIT unwind designed but not implemented; native acceptance remains)
...
- **Blocked on / design doc:** section 7.9 implementation plus native Stage E evidence with W-014; [win32_faults_and_stacks.md](win32_faults_and_stacks.md)
- **Opened:** 2026-07-16
- **Updated:** 2026-07-27 — recovery/GC and chain probes pass; static fatal boundaries reach UEF/minidump; section 7.9 completes the dynamic-JIT unwind design and identifies the XMM12-XMM15 boundary gap; implementation and native policy/debugger/stack-budget acceptance remain
...
4. **W-010/W-014 Stage E** — implement §7.9 dynamic-JIT unwind, complete native XMM6-XMM15 boundary preservation, then run native policy/fault/stack acceptance.
