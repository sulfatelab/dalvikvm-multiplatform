...
- **Blocked on / design doc:** no blocker for core managed-fault delivery; broader dynamic-table sampling/churn, debugger, forced-policy, stack-budget, exception-unwind XMM, pending-range, and embedding acceptance remain; [win32_faults_and_stacks.md](win32_faults_and_stacks.md)
- **Opened:** 2026-07-16
...
- **W-010 ownership boundary:** W-014 owns bounds, stack-guarantee configuration, `_beginthreadex` reservation and pthread lifetime, and stack accounting. W-010 owns VEH/context adaptation for AV-based managed faults, explicit Win64 stack-check generation, quick-entrypoint redirection, and fatal unwind/diagnostics.
...
- **Opened:** 2026-07-16
- **Updated:** 2026-07-28 — E9 guarantee-aware bounds plus explicit Win64 checks pass the complete native 30-record runner
...
4. **W-010/W-014 residual Stage E** — keep the native-accepted E9 30/30
   matrix green while completing dynamic-table churn/sampling, debugger,
   forced-policy, pending-tail, exception-unwind XMM, embedding, and
