...
- **Blocked on / design doc:** live recursive unwind isolation above GenericJNI, a replacement Windows SOE delivery design, then the repaired Stage E fatal/SOE matrix and broader dynamic-table sampling/churn acceptance; [win32_faults_and_stacks.md](win32_faults_and_stacks.md)
- **Opened:** 2026-07-16
- **Updated:** 2026-07-28 — native run 4 proves the GenericJNI RDI repair is insufficient and isolates the remaining failure to traversal through ART managed/GenericJNI caller frames; bounded live unwind tracing is next
...
4. **W-010/W-014 Stage E** — trace live native unwind progress above the repaired GenericJNI frame and identify the first failing boundary; design a replacement Windows SOE delivery mechanism after native evidence invalidated the fixed page; then repeat repaired fatal/SOE paths and complete dynamic-table churn/sampling, debugger, policy, and stack-budget acceptance.
