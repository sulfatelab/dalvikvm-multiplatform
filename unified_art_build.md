...
| Linux x86-64 product | COMPLETE for the current W-003/W-004/W-013 runtime slice | exact-target CriticalNative and normal/FastNative W-003 gates join all eleven W-004 gates, including imageless and generated-boot-image Hello plus HandleLeak, PerfSmoke, ThreadHeavy, and libcore CoreProbe/InterruptProbe, and the shared W-013 128 MiB non-moving-heap gate; the staged runtime includes its verified ART/OAT/VDEX image set | migrate the remaining behavioral stages |
...
| Total | 23 EXEs, 10 DLLs, 47 managed, 13 gates | 38 exact / 55 typed | product: 72 target-runnable, 8 host-review, 13 compile-only | Windows applies 90 declarations (69 runnable, eight host-review, 13 compile-only); Linux x86-64 applies 17 (fourteen runnable, three compile-only), and Linux AArch64 applies 16 (thirteen runnable, three compile-only) |
...
The managed libcore CoreProbe and InterruptProbe independently list the same
exact three-target set. CoreProbe exercises platform-neutral arraycopy, UTF-8
charset, reflection, and monitor/thread behavior; InterruptProbe proves sleeper
interruption and termination. Every other declaration in their shared case
directory retains the Windows x86-64/MSVC selector pending independent review.
...
- Linux x86-64 builds and runs the two W-003 JNI ABI probes through four exact
  declarations, in addition to its eleven runnable W-004 gates and shared W-013
  gate;
- Linux AArch64 builds and runs both W-003 JNI probes through four exact
  ...
  libcore CoreProbe and InterruptProbe, and the shared 128 MiB W-013 gate under
