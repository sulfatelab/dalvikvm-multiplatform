...
def main() -> int:
    ...
    for mode in ("nterp", "switch", "jit"):
        env_extra = {"ART_WINDOWS_X64_QUICK_INVOKE": "1"}
        vm_args: list[str] = []
        if mode == "nterp":
            env_extra.update(ART_WINDOWS_X64_JIT="0", ART_WINDOWS_X64_NTERP="1")
        elif mode == "switch":
            env_extra.update(ART_WINDOWS_X64_JIT="0", ART_WINDOWS_X64_NTERP="0")
        else:
            env_extra.update(
    ...
    run_case(
        ...
        forbidden=(*handled_forbidden, "Windows x64 CompileMethod done success=1 method="),
        env_extra={"ART_WINDOWS_X64_NTERP": "0"},
    )
        ...
        run_fatal_case(
            ...
            markers=(
                ...
                *mode_markers,
                ...
                "ART_WINDOWS_X64_UNWIND_TRACE frame=",
            ...
            env_extra={"ART_WINDOWS_X64_FATAL_UNWIND_TRACE": "1"},
        )
    run_case(
        root,
    ...
    for mode in ("j2", "j1"):
        ...
        run_fatal_case(
            ...
            env_extra={
                ...
                "ART_WINDOWS_X64_JIT_DUAL": "1" if mode == "j2" else "0",
