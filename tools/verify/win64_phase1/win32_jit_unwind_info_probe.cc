...
void TestLargeAllocations() {
  ...
  Win64UnwindInfoBuilder unscaled;
  unscaled.Enable();
...
void TestInvalidInputs() {
  ++g_cases;
  ExpectInvalid([](Win64UnwindInfoBuilder* builder) {
  ...
  Win64UnwindInfoBuilder short_prologue;
  ...
  Win64UnwindInfoBuilder long_prologue;
  ...
  Win64UnwindInfoBuilder double_finalize;
