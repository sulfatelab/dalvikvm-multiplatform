...
SRC="$REPO/tools/verify/windows_x64_phase3/src/NetProbe.java"
...
import zipfile, os
repo=r'''$REPO'''
dex=os.path.join(repo,'tools/verify/windows_x64_phase3/bin/netdex/classes.dex')
out=os.path.join(repo,'build/windows_x64_phase1/run/netprobe.jar')
