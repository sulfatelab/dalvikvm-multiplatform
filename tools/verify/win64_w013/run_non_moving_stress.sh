...
SRC="$REPO/tools/verify/win64_w013/src/W013NonMovingStressProbe.java"
OUT="$REPO/tools/verify/win64_w013/bin"
...
echo 'W013_NON_MOVING_STRESS_PASS win64=ok linux=ok total_bytes=75497472'
