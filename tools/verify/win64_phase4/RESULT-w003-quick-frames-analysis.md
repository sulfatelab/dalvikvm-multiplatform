...
**Status:** BOUNDARY, STRUCTURAL, WINE, AND HOST PACKAGING COMPLETE; native execution remains
...
D execution remains required before closing W-003.

The Stage D package is generated by
`tools/win64/host_package/package_win64_w003.sh`. Before issuing the ZIP, the
