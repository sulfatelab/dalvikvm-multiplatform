...
checks = {
    ...
    'initial_veh': 'ART Win64 VEH: exception 0xc0000005' in text,
    'unhandled_exception_filter': 'ART Win64 UEF: exception 0xc0000005' in text,
    'minidump_marker': 'ART Win64 crash: minidump written to ' in text,
}
valid_dumps=[]
for path in new:
    try:
