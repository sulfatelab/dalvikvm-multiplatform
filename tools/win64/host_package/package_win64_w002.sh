...
OUT="${1:-$REPO/dist/win64_w002_host}"
JOBS="${JOBS:-16}"
...
REPEATS=2 WINEDEBUG="$WINEDEBUG" "$REPO/tools/verify/win64_phase4/run_w002_osr_probe.sh"
REPEATS=2 WINEDEBUG="$WINEDEBUG" "$REPO/tools/verify/win64_phase4/run_w002_attach_probe.sh"
...
cp -a "$REPO/tools/verify/win64_phase4/host/RUN_W002_HOST.ps1" "$OUT/scripts/"
cp -a "$REPO/tools/verify/win64_phase4/W002_HOST_CHECKLIST.md" "$OUT/"
...
clean_runtime_outputs
write_manifests
python3 "$REPO/tools/verify/win64_phase4/check_w002_host_package.py" "$OUT"
python3 "$REPO/tools/verify/win64_phase4/smoke_w002_host_package_wine.py" "$OUT"
clean_runtime_outputs
write_manifests
python3 "$REPO/tools/verify/win64_phase4/check_w002_host_package.py" "$OUT"
