...
clean_runtime_outputs
write_manifests
python3 "$REPO/tools/verify/win64_phase4/check_w010_w014_host_package.py" "$OUT"
python3 "$REPO/tools/verify/win64_phase4/smoke_w010_w014_host_package_wine.py" "$OUT"
clean_runtime_outputs
write_manifests
python3 "$REPO/tools/verify/win64_phase4/check_w010_w014_host_package.py" "$OUT"
