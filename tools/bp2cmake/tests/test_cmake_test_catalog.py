...
"""
    ...
    assert len(catalog["probes"]) == 108
    assert sum(probe["applicable"] for probe in catalog["probes"]) == 105
    assert sum(bool(probe["target_ids"]) for probe in catalog["probes"]) == 54
