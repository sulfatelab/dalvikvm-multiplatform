...
"""
    ...
    assert len(catalog["probes"]) == 110
    assert sum(probe["applicable"] for probe in catalog["probes"]) == 107
    assert sum(bool(probe["target_ids"]) for probe in catalog["probes"]) == 56
