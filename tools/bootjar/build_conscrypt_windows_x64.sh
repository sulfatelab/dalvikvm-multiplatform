...
# boot classes, package security.properties, re-dex boot.jar for Win32 ART.
#
# Prerequisites:
#   - /tmp/bootbuild/classes from tools/bootjar/build.sh (+ optional build_windows_x64 overlay)
#   - JDK 21 javac
...
STAGE_BOOT="${MDVM_STAGE_BOOT:-$REPO/build/windows_x64_phase1/run/boot.jar}"
...
# Win32 ART multipath boot security.properties (L-002 C2)
