...
FRAME_BUILD="${FRAME_BUILD:-$REPO/build/windows_x64_w003_frames}"
FRAME_NATIVE_BUILD="${FRAME_NATIVE_BUILD:-$REPO/build/windows_x64_w003_frame_probe}"
XMM_NATIVE_BUILD="${XMM_NATIVE_BUILD:-$REPO/build/windows_x64_w003_xmm_sentinel}"
OUT="${1:-$REPO/dist/windows_x64_w003_host}"
JOBS="${JOBS:-32}"
...
REPEATS=2 \
WINEDEBUG="$WINEDEBUG" \
  "$REPO/tools/verify/windows_x64_phase4/run_w003_frame_probe.sh"
...
cp -a "$REPO/tools/verify/windows_x64_phase4/host/RUN_W003_HOST.ps1" "$OUT/scripts/"
cp -a "$REPO/tools/verify/windows_x64_phase4/W003_HOST_CHECKLIST.md" "$OUT/"
...
clean_runtime_outputs
write_manifests
python3 "$REPO/tools/verify/windows_x64_phase4/check_w003_host_package.py" "$OUT"
python3 "$REPO/tools/verify/windows_x64_phase4/smoke_w003_host_package_wine.py" "$OUT"
clean_runtime_outputs
write_manifests
python3 "$REPO/tools/verify/windows_x64_phase4/check_w003_host_package.py" "$OUT"
