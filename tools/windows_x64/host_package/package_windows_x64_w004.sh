...
cp -a "$REPO/tools/verify/windows_x64_phase4/host/RUN_W004_HOST.ps1" "$OUT/scripts/"
cp -a "$REPO/tools/verify/windows_x64_phase4/W004_HOST_CHECKLIST.md" "$OUT/"
...
clean_runtime_outputs
write_manifests
python3 "$REPO/tools/verify/windows_x64_phase4/check_w004_host_package.py" "$OUT"
python3 "$REPO/tools/verify/windows_x64_phase4/smoke_w004_host_package_wine.py" "$OUT"
clean_runtime_outputs
write_manifests
python3 "$REPO/tools/verify/windows_x64_phase4/check_w004_host_package.py" "$OUT"
