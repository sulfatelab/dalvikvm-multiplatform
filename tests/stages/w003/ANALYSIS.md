...
[XMM sentinel result](../../cases/w003-xmm-sentinel/RESULT.md). The attributed
counter design, representative counts, nterp null-fault isolation, and 8/8
Wine result are recorded in
[frame-family result](../../cases/w003-frame-probe/RESULT.md).

The standalone Stage D package producer and its repository-side PowerShell
runner were retired after unified native acceptance. Before the historical ZIP
was issued, that pipeline reran the structural gate and both focused Wine matrices, validated
