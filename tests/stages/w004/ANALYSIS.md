...
Windows Server 2025 x86-64 passes all 33 gates, including the exact-target ART
...
passes 33/33 again. The UDP gate maps
...
The XML gate requires namespace-aware parsing, three elements, and the exact
