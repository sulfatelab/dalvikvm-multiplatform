...
| [win32_aot_oat.md](win32_aot_oat.md) | Early boot-only Windows AOT design: Linux-identical ART ELF identity, the OAT-1 private-copy loader, PE32+ rejection, the AOT unwind format/transport, and acceptance gates. Windows AOT is not implemented |
