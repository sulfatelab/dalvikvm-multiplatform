...
| [win32_aot_oat.md](win32_aot_oat.md) | Early boot-only Windows AOT design: Linux-identical ART ELF identity, 64-KiB Windows artifact alignment, the OAT-1 private-copy loader, unwind/CFG transports, and acceptance gates. Generation step 1 is partial; executable loading is not implemented |
| [win32_aot_oat_tracker.md](win32_aot_oat_tracker.md) | Live Windows AOT/OAT implementation sequence, evidence rules, W-028 compiler-gate status, and remaining native acceptance work |
