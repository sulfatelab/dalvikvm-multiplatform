...
| [win32_aot_oat.md](win32_aot_oat.md) | Early boot-only Windows AOT design: Linux-identical ART ELF identity, 64-KiB Windows artifact alignment, the implemented OAT-1 private-copy ELF/VDEX loader, LZ4 boot-image strategy, unwind/CFG transports, and acceptance gates. W-031 accepts the core unwind transport; W-032 completes the CFG metadata transport and guarded forced-policy observation, not explicit enforcement |
| [win32_aot_oat2.md](win32_aot_oat2.md) | Detailed optional OAT-2 design: one combined placeholder-partitioned boot span, pagefile-section backing, exact primary R/RW/RX-invalid views, a temporary RW/NX construction alias, CFG publication ordering, ownership/rollback, and W-033 through W-035 gates |
