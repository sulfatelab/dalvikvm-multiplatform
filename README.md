...
| [win32_aot_oat.md](win32_aot_oat.md) | Early boot-only Windows AOT design: Linux-identical ART ELF identity, 64-KiB Windows artifact alignment, the implemented OAT-1 private-copy ELF/VDEX loader, LZ4 boot-image strategy, unwind/CFG transports, and acceptance gates. W-030 accepts canonical experimental boot loading; real boot-OAT execution remains open |
| [win32_aot_oat_tracker.md](win32_aot_oat_tracker.md) | Live Windows AOT/OAT implementation sequence, accepted W-028/W-029/W-030 evidence, per-generation cache-set integrity, and remaining unwind/CFG/execution/product-integration work |
