...
| [win32_aot_oat.md](win32_aot_oat.md) | Early boot-only Windows AOT design: Linux-identical ART ELF identity, 64-KiB Windows artifact alignment, the OAT-1 private-copy loader, unwind/CFG transports, and acceptance gates. Native generation step 1 is complete; boot-image generation and executable loading are not implemented |
| [win32_aot_oat_tracker.md](win32_aot_oat_tracker.md) | Live Windows AOT/OAT implementation sequence, accepted W-028 compiler-gate evidence, and remaining boot-generation/loader work |
