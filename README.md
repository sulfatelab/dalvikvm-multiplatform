...
| [win32_aot_oat.md](win32_aot_oat.md) | Early boot-only Windows AOT design: Linux-identical ART ELF identity, 64-KiB Windows artifact alignment, the implemented OAT-1 private-copy ELF/VDEX loader, LZ4 boot-image strategy, unwind/CFG transports, and acceptance gates. W-031 accepts the core unwind transport, underlying managed/JNI body lookup, and JIT-disabled runtime calls; normal boot-OAT dispatch remains open |
| [win32_aot_oat_tracker.md](win32_aot_oat_tracker.md) | Live Windows AOT/OAT implementation sequence, accepted W-028 through W-031 evidence, per-generation cache-set integrity, and remaining unwind/CFG/dispatch/product-integration work |
